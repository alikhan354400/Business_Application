...
{
    public class PrintPurchaseReceiptViewModel
    {
        ...
        public IList<PrintPODetail> ItemDetail { get; set; }
        public CompanyInformation CompanyInfo { get; set; }

        public PrintPurchaseReceiptViewModel()
        {
            ItemDetail = new List<PrintPODetail>();
            CompanyInfo = new CompanyInformation();
        }
    }

    public class PrintPODetail
    {
