...
namespace HassanAyoubTraders.Controllers
{
    ...
    public class VendorsController : BaseController
    {
        ...
        public ActionResult VendorList()
        {
            ...
            vm.AccountList = _repository.BrowseAccount().Where(x => x.AccountType.Equals("Supplier") && x.RoleID.Equals(GetCurrentUserRole())).ToList();
            return View(vm);
        }
        ...
        public ActionResult VendorDelete(int Id)
        {
            ...
            return Redirect(GetWebsiteUrl() + "/Vendors/VendorList");
        }
    }
}